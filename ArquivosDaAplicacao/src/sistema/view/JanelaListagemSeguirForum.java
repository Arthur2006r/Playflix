...
public class JanelaListagemSeguirForum extends JDialog {
	...
	public JanelaListagemSeguirForum(List<Forum> foruns) {
		setTitle("Listagem de Fóruns - Seguir");
		setSize(800, 400);
		...
		JButton btnExcluir = new JButton("Seguir");
		btnExcluir.setBackground(new Color(148, 0, 211));
