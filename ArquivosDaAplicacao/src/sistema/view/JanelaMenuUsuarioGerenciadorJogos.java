...
public class JanelaMenuUsuarioGerenciadorJogos extends JDialog {

	private static final long serialVersionUID = 1L;
	private final JPanel contentPanel = new JPanel();
	private int opcao = 0;

	public JanelaMenuUsuarioGerenciadorJogos(Usuario usuario) {
		setModal(true);
		...
		JLabel lblTituloJanela = new JLabel("Menu Usuário - Gerenciar de Jogos");
		...
		}
		{
			...
			}
			{
				...
				panel_1.setLayout(new GridLayout(0, 1, 0, 0));
				{
					...
					{
						JButton btnCadastrarForum = new JButton("Cadastrar Jogo");
					...
					{
						JButton btnEditarForum = new JButton("Editar Jogo");
					...
					{
						JButton btnExcluirForum = new JButton("Excluir Jogo");
					...
					{
						JButton btnListarMeusForuns = new JButton("Listar Meus Jogos");
					...
					{
						JButton btnListarForuns = new JButton("Listar Jogos");
