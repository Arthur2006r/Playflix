...
public class JanelaMenuUsuarioGerenciadorGeneros extends JDialog {

	private static final long serialVersionUID = 1L;
	private final JPanel contentPanel = new JPanel();
	private int opcao = 0;

	public JanelaMenuUsuarioGerenciadorGeneros(Usuario usuario) {
		setModal(true);
		...
		JLabel lblTituloJanela = new JLabel("Menu Usuário - Gerenciar de Gêneros");
		...
		}
		{
			...
			}
			{
				...
				panel_1.setLayout(new GridLayout(0, 1, 0, 0));
				{
					...
					{
						JButton btnCadastrarForum = new JButton("Cadastrar Gênero");
					...
					{
						JButton btnEditarForum = new JButton("Editar Gênero");
					...
					{
						JButton btnExcluirForum = new JButton("Excluir Gênero");
					...
					{
						JButton btnListarMeusForuns = new JButton("Listar Meus Gêneros");
					...
					{
						JButton btnListarForuns = new JButton("Listar Gêneros");
