...
public class JanelaListagemPararDeSeguirForum extends JDialog {
	...
	public JanelaListagemPararDeSeguirForum(List<Forum> foruns) {
		setTitle("Listagem de Fóruns - Parar de Seguir");
		setSize(800, 400);
		...
		JButton btnExcluir = new JButton("Para de seguir");
