...
public class JanelaCadastroForum extends JDialog {
	...
	public JanelaCadastroForum(List<Genero> generos, Usuario usuario) {
		...
		JLabel lblNewLabel = new JLabel("Cadastro de Fórum");
